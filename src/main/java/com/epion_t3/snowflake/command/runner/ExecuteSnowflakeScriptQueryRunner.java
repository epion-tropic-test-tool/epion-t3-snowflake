...
import com.epion_t3.snowflake.command.model.ExecuteSnowflakeScriptQuery;
 ...
 */
@Slf4j
public class ExecuteSnowflakeScriptQueryRunner extends AbstractCommandRunner<ExecuteSnowflakeScriptQuery> {

    /**
     * {@inheritDoc}
     */
    @Override
    public CommandResult execute(ExecuteSnowflakeScriptQuery command, Logger logger) throws Exception {
